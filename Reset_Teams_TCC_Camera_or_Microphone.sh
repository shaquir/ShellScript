...
#kTCCServiceCamera|com.microsoft.teams
...
if [[ -z "$loggedInUser" ]]; then
	...
	if [[ "$disabledValues" == *"kTCCServiceMicrophone|com.microsoft.teams"* ]]&&[[ "$disabledValues" == *"kTCCServiceCamera|com.microsoft.teams"* ]]; then
	...
	elif [[ "$disabledValues" == *"kTCCServiceMicrophone|com.microsoft.teams"* ]];
	then
	...
	elif [[ "$disabledValues" == *"kTCCServiceCamera|com.microsoft.teams"* ]];
	then
